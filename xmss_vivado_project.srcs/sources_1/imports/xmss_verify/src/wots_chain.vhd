...
-- 
-- Modified: Robustez para 0-iteraciones (Zero-length chains deadlock fixed)
----------------------------------------------------------------------------------
...
begin
    ...
    begin
       ...
       case r.state is      
           ...
           when S_LOOP =>
              -- 1. Evaluamos si hemos llegado al paso de la firma
              if r.cnt = r.signature_step then
                    q.done_inter <= '1';
                    v.halt_self := '1';    
              end if;
              
              -- 2. Evaluamos si la cadena ha terminado
       ...
       -- [BULLLETPROOF FIX]: Suprimir cualquier petición de hash si estamos congelados
